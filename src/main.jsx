...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://world-tour-server-red.vercel.app/allServices/${params.id}`
          ),
      },
      {
        path: "/addService",
      ...
      },
      {
        ...
        loader: () => fetch(`https://world-tour-server-red.vercel.app/booked`),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://world-tour-server-red.vercel.app/addPackage/${params.id}`
          ),
      },
      {
        path: "/myPackages",
